# Generated by Django 3.2.9 on 2022-01-29 22:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.TextField(blank=True, choices=[('Aprobado', 'Aprobado'), ('En curso', 'En curso'), ('Reprobado', 'Reprobado')], max_length=50, verbose_name='Estado')),
                ...
                ('upload', models.FileField(max_length=50, upload_to='uploads/%Y/%m/%d/', validators=[components.crud.models.file_size], verbose_name='Documento')),
